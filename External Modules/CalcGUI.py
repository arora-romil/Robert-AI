...
input_field = Entry(input_frame, font=('merriweather', 18, 'bold'),
...
clear = Button(btns_frame, text="C", fg="black", width=21, height=3, bd=0, bg="#2a2d36",
               cursor="hand2", command=lambda: bt_clear()).grid(row=0, column=0, columnspan=2, padx=1, pady=1)
...
close = Button(btns_frame, text="Close", fg="black", width=10, height=3, bd=0, bg="#eee",
                cursor="hand2", command=lambda: bt_close()).grid(row=0, column=2, padx=1, pady=1)
